...
//
//class MainActivityXXX : AppCompatActivity() {
...
//        private val deleteIcon = ContextCompat.getDrawable(this@MainActivityXXX, R.drawable.ic_delete_sweep_white_24dp)
//        private val background = ColorDrawable(ContextCompat.getColor(this@MainActivityXXX, R.color.delete_swipe_background))
//        private val deleteIconMargin = this@MainActivityXXX.resources.getDimension(R.dimen.delete_icon_margin).toInt()
//
